...
def naive_convolve(f, g):
    ...
    # smid and tmid are number of pixels between the center pixel and the edge, ie for a 5x5 filter they will be 2.
    #
    ...
    for x in range(xmax):
        for y in range(ymax):
            # Calculate pixel value for h at (x,y). Sum one component for each pixel (s, t) of the filter g.
